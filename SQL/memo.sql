...
create table if not exists `student`(
	id char(12) primary key comment '学生编号',
	name varchar(13) not null comment '学生姓名',
	birthday date  not null comment '学生生日',
	gender  enum('男','女') not null comment '学生性别',
	email varchar(64) unique key comment '学生邮箱',
	idcard char(18) not null unique key comment '学生身份证',
	photo  varchar(256) default 'http://img.bittech.com/default.png' comment '学生证件照',
	address varchar(128) default '' comment '学生家庭住址'
) engine innodb;

    ...
    /*{*/
        ...
        /*{*/
            ...
            /*{*/
                ...
                /*close(in_fd);*/
            /*}*/
            /*void DisplayEverCommand(char** command,char** parameters);*/
            /*DisplayEverCommand(command,parameters);*/
...
void proc()
{
    ...
    int i = 0;
    for(; i < MAX_EVER_ARG;i++)
    {
      parameters[i] = (char *)malloc(sizeof(char)*MAX_EVER_ARG);
    }
    int para_num ;
    //子进程的退出状态
    int status;
    ...
    while(1)
    {
      ...
      for(; i < MAX_EVER_ARG;i++)
      {
        memset(parameters[i],0,MAX_EVER_ARG);
      }
      int para_num = read_command(&command,parameters,promopt);
      /*while(*command)*/
      /*{*/
        /*memset(*command,0,sizeof())*/
      /*}*/
      if( para_num == -1 )
      {
        printf("-1\n");
